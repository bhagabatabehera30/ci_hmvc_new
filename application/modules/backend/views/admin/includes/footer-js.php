  ...
  <script>
        ...
        <script src="<?=ASSETS2_ADMIN?>assets/js/bootstrap.min.js"></script>
        <script src="<?=ASSETS2_ADMIN?>assets/js/detect.js"></script>
        <script src="<?=ASSETS2_ADMIN?>assets/js/fastclick.js"></script>
        <script src="<?=ASSETS2_ADMIN?>assets/js/jquery.blockUI.js"></script>
        <script src="<?=ASSETS2_ADMIN?>assets/js/waves.js"></script>
        <script src="<?=ASSETS2_ADMIN?>assets/js/jquery.slimscroll.js"></script>
        <script src="<?=ASSETS2_ADMIN?>assets/js/jquery.scrollTo.min.js"></script>
...
<?php if(js_for_dashboard == 'Y'){ ?>
  <!-- Dashboard init -->
        <script src="<?=ASSETS2_ADMIN?>assets/pages/jquery.dashboard.js"></script>
<?php } ?>
 ...
 <script src="<?=ASSETS?>plugins/bootstrap-tagsinput/js/bootstrap-tagsinput.min.js"></script>
       ...
       <script src="<?=ASSETS2_ADMIN?>assets/pages/jquery.autocomplete.init.js"></script> 
		<script src="<?=ASSETS2_ADMIN?>assets/pages/jquery.form-advanced.init.js"></script>   
...
<script src="<?=ASSETS?>plugins/datatables/jquery.dataTables.min.js"></script>
        ...
        <!-- init -->
        <script src="<?=ASSETS2_ADMIN?>assets/pages/jquery.datatables.init.js"></script>
        <!--<script src="<?=ASSETS2_ADMIN?>assets/js/icheck.min.js"></script>-->
<?php } ?>
       <script src="<?=ASSETS?>plugins/tooltipster/tooltipster.bundle.min.js"></script>
        <script src="<?=ASSETS2_ADMIN?>assets/pages/jquery.tooltipster.js"></script>
        <!-- App js -->
        <script src="<?=ASSETS2_ADMIN?>assets/js/jquery.core.js"></script>
        <script src="<?=ASSETS2_ADMIN?>assets/js/jquery.app.js"></script>
 <?php if(js_for_list_pages=='Y'){ ?>
        <script>
