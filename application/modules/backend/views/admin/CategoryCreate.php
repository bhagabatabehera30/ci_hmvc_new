    ...
    <?php echo display_session_msg();?>
     ...
     <?php } ?>
                               ...
                               <form name="forminput" class="row form-horizontal" method="post" action="<?=Adminpath?>CategoryCreate" onSubmit="return PostSearchForm()">
				...
				<p class="help-block"><?=form_error('parent_category_id')?></p> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="catname_short"  class="form-control" id="" placeholder="Category short name" value="">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="checkbox"  name="IsTopNav"  value="Y" id="switch1" data-switch="bool">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="checkbox" name="IsFooter" value="Y" id="switch2" data-switch="bool">
									...
									<div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <input type="checkbox"  name="CompanyInFooter"   value="Y" id="switch3" data-switch="bool">
                                             <label for="switch3" data-on-label="Yes"
                                                           data-off-label="No"></label> <br />(In Company Section)
												</div><div class="col-sm-2">
                                            <input type="checkbox"  name="SupportInFooter"   
											value="Y" id="switch4" data-switch="bool">
											...
											value="Y" id="switch5" data-switch="bool"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <input type="text" id="touchspin-demo-1" name="SortOrder" class="vertical-spin"    placeholder="Sort Order  should be integer" value="">
                                        </div>
                                    </div>
