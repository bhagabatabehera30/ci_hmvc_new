		...
		<?php 
		 ...
		 ?>
          ...
          <p class="help-block"><?=form_error('Privilege[]')?></p>
				  ...
				  <option value="S" <?php if($adm_user_details->View=='S'){echo 'selected';}?>>User</option>
				  <option value="O" <?php if($adm_user_details->View=='O'){echo 'selected';}?>>Admin</option>
				  </select>	    
                  
                  <?php }  
				   if($AdminUserDetails->status=="S"){  ?>
				 <select name="status" class="form-control">
				  <option value="S" <?php if($adm_user_details->View=='S'){echo 'selected';}?>>User/Employee</option>
				  </select> 	     
