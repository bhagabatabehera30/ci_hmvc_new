...
<div class="row">
    ...
    <?php echo display_session_msg();?>
     ...
     <?php } ?>  
                                <div class="card-box table-responsive">
                                    ...
                                    <form name="forminput" class="row form-horizontal" method="post" action="<?=Adminpath?>adminUserEdit/<?=$adm_user_details->adm_id;?>" onSubmit="return PostSearchForm()" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="SecondaryLogId" class="form-control" id="" placeholder=" LogIn Id/User Id" value="<?=$adm_user_details->adm_login_id;?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="password" name="SecondaryPassword"  class="form-control" id="" placeholder=" Password" value="<?=$adm_user_details->adm_conpwd;?>">                                    <p class="help-block"><?=form_error('SecondaryPassword')?></p>
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="password" name="CSecondaryPassword"  class="form-control" id="" placeholder=" Password" value="<?=$adm_user_details->adm_conpwd;?>">
                                   ...
                                   <h5 class="box-title hd_dashed">Your Other Details</h5>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="adm_name" type="text"  class="form-control" value="<?=$adm_user_details->adm_name;?>" placeholder="Name">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="adm_email" type="text"  class="form-control" value="<?=$adm_user_details->adm_email;?>" placeholder="email id">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="adm_phone" type="text" class="form-control" value="<?=$adm_user_details->adm_phone;?>" placeholder="mobile number">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="adm_address" class="form-control" cols="30" rows="4" placeholder="address"><?=$adm_user_details->adm_address;?></textarea>
                                        
                                             <p class="help-block"><?=form_error('adm_address')?></p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input name="adm_city" type="text"  class="form-control" placeholder="city"  value="<?=$adm_user_details->adm_city;?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input name="adm_state" type="text"  placeholder="state" class="form-control"  value="<?=$adm_user_details->adm_state;?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                           <input name="adm_zipcode" type="text" placeholder="pincode" class="form-control" value="<?=$adm_user_details->adm_zipcode;?>">
	    ...
	    $arrvalue=explode(",",$adm_user_details->adm_privi);  ?>
           <?php 
		...
		<?php 
		 ...
		 ?>
          ...
          <p class="help-block"><?=form_error('Privilege[]')?></p>
                     ...
                     <div class="col-sm-6">
                      <?php if($AdminUserDetails->status=="O"){ ?>
                                                    ...
                                                    <div class="checkbox checkbox-primary">
                                                            ...
                                                            <input type="checkbox" id="checkbox1" name="View" value="Y" <?php if($adm_user_details->View=='Y'){echo 'checked';}?>><label for="checkbox1"> View</label>
                                                    </div>
                                                    <div class="checkbox checkbox-success">
                                                       
                                                            <input type="checkbox" id="checkbox2"  class="custom-checkbox" name="Generate" value="Y" <?php if($adm_user_details->Generate=='Y'){echo 'checked';}?>><label for="checkbox2"> Add</label>
                                                    </div>
                                        <div class="checkbox checkbox-info">
                                                        
                                                            <input type="checkbox" id="checkbox3" class="custom-checkbox" name="Edit" value="Y" <?php if($adm_user_details->Edit=='Y'){echo 'checked';}?>><label for="checkbox3"> Edit</label>
                                                    </div>
                                                    <div class="checkbox checkbox-danger">
                                                        
                                                            <input type="checkbox" id="checkbox4"  class="custom-checkbox" name="Remove" value="Y" <?php if($adm_user_details->Remove=='Y'){echo 'checked';}?>><label for="checkbox4"> Delete</label>
                                                    </div>
										...
										?>         
                                           ...
                                           <div class="checkbox checkbox-primary">
                                                            ...
                                                            <input type="checkbox" id="checkbox1" class="custom-checkbox"  name="View" value="Y" <?php if($adm_user_details->View=='Y'){echo 'checked';}?>><label for="checkbox1"> View</label>
                                                    </div>
				  ...
				  <option value="S" <?php if($adm_user_details->status=='S'){echo 'selected';}?>>User</option>
				  <option value="O" <?php if($adm_user_details->status=='O'){echo 'selected';}?>>Admin</option>
				  </select>	    
                  
                  <?php }  
				   if($AdminUserDetails->status=="S"){  ?>
				 <select name="status" class="form-control">
				  <option value="S" <?php if($adm_user_details->status=='S'){echo 'selected';}?>>User/Employee</option>
				  </select> 	     
				 ...
				 <?php } ?> 
                     ...
                     <div class="col-sm-6">
                                         ...
                                         <input name="Role" class="form-control" value="<?=$adm_user_details->Role;?>" placeholder="Role/Designation">
	...
	<?php
	 $user_image=$adm_user_details->user_image;
	 
	 // if($adm_user_details->user_image!='')
	if($adm_user_details->user_image!='' && file_exists("./cdn/UserImage/$user_image"))
	{ ?>
	<img src="<?=CDN_PATH?>UserImage/<?=$adm_user_details->user_image;?>" height="100" width="100"> 
    <!--<button type="submit" onClick="RemoveImg();">Remove Photo</button>-->
    <br> 
	<input type="hidden" name="user_image2" value="<?=$adm_user_details->user_image;?>">
<?php } else { ?>
...
<?php } ?> 
	<input name="user_image" type="file" />
				  ...
				  <option value="Active" <?php if($adm_user_details->adm_status=='Active'){ echo 'selected';} ?>>Active</option>
				  <option value="Inactive" <?php if($adm_user_details->adm_status=='Inactive'){ echo 'selected';} ?>>InActive</option>
				  </select>	
