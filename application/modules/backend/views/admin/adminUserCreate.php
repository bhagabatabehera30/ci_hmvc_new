...
<form name="forminput" class="row form-horizontal" method="post" action="<?=Adminpath?>adminUserCreate" onSubmit="return PostSearchForm()" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="SecondaryLogId" class="form-control"  placeholder=" LogIn Id/User Id" value="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="password" name="SecondaryPassword"  class="form-control"  placeholder=" Password" value="">                                    <p class="help-block"><?=form_error('SecondaryPassword')?></p>
                                        </div>
                                    </div>
                                     <div class="form-group">
